(function (global, factory) {
  ...
  var FileLocalProvider = function () {
    ...
    _createClass(FileLocalProvider, [{
      ...
      key: '_getFileInfo',
      value: function _getFileInfo(file, callback) {
        if (file.blob) this._getBlobInfo(file, callback);else if (file.url) this._getImageInfo(file, callback);else callback(file);
      }
    }, {
      key: '_getBlobInfo',
      value: function _getBlobInfo(file, callback) {
      ...
      key: '_getImageInfo',
      value: function _getImageInfo(file, callback) {
        var img = new Image();
        img.onload = function () {
          file.imageWidth = img.width + 'px';
          file.imageHeight = img.height + 'px';
